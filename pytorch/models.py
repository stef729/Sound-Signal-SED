...
class Cnn_13layers_AvgPooling(nn.Module):
    def __init__(self, classes_num):
        ...
        self.event_fc = nn.Linear(2048, classes_num, bias=True)
        self.elevation_fc = nn.Linear(2048, classes_num, bias=True)
        self.azimuth_fc = nn.Linear(2048, classes_num, bias=True)
