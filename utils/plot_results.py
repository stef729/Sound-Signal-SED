...
def plot_results(args):
    ...
    # Test 1 
    dataset_dir = 'D:/Project/DCASE/data/2019-task3/development'
    workspace = 'D:/Project/DCASE/QiuqiangKong/dcase2019_task3'
    audio_type = 'foa'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_dir', type=str, required=False, help='Directory of dataset.')
    parser.add_argument('--workspace', type=str, required=False, help='Directory of your workspace.')
    parser.add_argument('--audio_type', type=str, choices=['foa', 'mic'], required=False)
